...
if "JUPYTERHUB_API_TOKEN" in os.environ:
    ...
    command = ["/Users/malcolm/dev/langchain-ai/rag-from-scratch/vendor/jupyter-stacks/bin/start-singleuser.py"] + sys.argv[1:]
...
command.append("/opt/homebrew/opt/jupyterlab/bin/jupyter")
